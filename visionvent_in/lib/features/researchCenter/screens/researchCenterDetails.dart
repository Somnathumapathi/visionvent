...
class ResearchCenterDetailsScreen extends StatelessWidget {
  const ResearchCenterDetailsScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                    "Research Centres are normally cross-departmental and multi-disciplinary in terms of their activities and the nature of research undertaken; however, they will be based in a single home Department for administrative and financial purposes. They may also include members or affiliated members from outside the institution."),
              ),
              SizedBox(
                height: 10,
              ),
              ...
              Center(
                  child:
                      CircularChart(title: '', value: 60, color: Colors.red)),
              SizedBox(
                height: 10,
              ),
              Text('Our Researches'),
